...
<head>
  ...
  <!-- CSS Files -->
  <link href="{{ asset('frontend/assets/css/soft-ui-dashboard.css') }}" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (request()->is('user/installment')) ? 'active' : '' }} " href="{{route('user.installment')}}">
            ...
            <span class="nav-link-text ms-1">Add Money</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (request()->is('user/get-my-discussion')) ? 'active' : '' }} " href="{{route('user.mydiscussion')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (request()->is('user/all-discussion')) ? 'active' : '' }} " href="{{route('user.allDiscussion')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>All Discussion</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g transform="translate(-2169.000000, -745.000000)" fill="#FFFFFF" fill-rule="nonzero">
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(453.000000, 454.000000)">
            ...
            <span class="nav-link-text ms-1">All Discussion</span>
          </a>
        </li>
  ...
  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    ...
    <div class="container-fluid">
      <div class="page-header min-height-300 border-radius-xl mt-4" @if (Auth::user()->coverimage)
          style="background-image: url(..{{ Auth::user()->coverimage}}); background-position-y: 50%;"
      @else
          style="background-image: url(../frontend/assets/img/banner.jpg); background-position-y: 50%;"
      @endif >
          ...
          <div class="col-lg-8 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 " href="{{route('singleReport')}}">
                ...
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1" href="{{route('allmemberReport')}}">
                    ...
                    <span class="ms-1">Overall</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 " href="{{route('deposits.export')}}">
...
<script src="{{ asset('frontend/assets/js/smooth-scrollbar.min.js') }}"></script>
  <script>
  ...
  <script src="{{ asset('frontend/assets/js/soft-ui-dashboard.min.js') }}"></script>
  @yield('script')
</body>
